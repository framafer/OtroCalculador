...
public class Display extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jB_AlmacenarBD = new javax.swing.JButton();
        jB_IrABaseDeDatos = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Calculadora de Paco");
        ...
        jB_AlmacenarBD.setText("Almacenar");
        jB_AlmacenarBD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jB_AlmacenarBDActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(64, 64, 64)
                .addComponent(jB_AlmacenarBD, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
                .addComponent(jB_IrABaseDeDatos, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jB_AlmacenarBDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_AlmacenarBDActionPerformed
        if(this.readyforSave){
            ...
            control.guardar(oper1,oper2,tipooper,result);

            this.mostrarMensaje("Operación guardada satisfactoriamente", "Info", "Guardado en Base de Datos");
         }
        
    }//GEN-LAST:event_jB_AlmacenarBDActionPerformed
    ...
    private void jTextOperando1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextOperando1FocusGained
        this.readyforSave = false;
    }//GEN-LAST:event_jTextOperando1FocusGained

    private void jTextOperando2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextOperando2FocusGained
        this.readyforSave = false;
    }//GEN-LAST:event_jTextOperando2FocusGained
    ...
    public void ponerValorEnJText(double valor,javax.swing.JTextField jtext ){
        NumberFormat frenchFormatter = NumberFormat.getInstance(new Locale("fr", "FR"));
        Number number;
        number = valor;
        String cadena = frenchFormatter.format(number);
    ...
    private javax.swing.JButton jB_AlmacenarBD;
